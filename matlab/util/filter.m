% Main script for calc_sos and filter generation for task II and III
% This MATLAB script plots poles and zeroes against the unit circle, then
% calls the created calc_sos() function to generate plots of each section
% described by the poles and zeros found in this file. 
